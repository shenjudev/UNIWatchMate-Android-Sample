...
import com.transsion.imagepicker.util.ProviderUtil;
...
public class ImagePicker {
    ...
    public static final int RESULT_CODE_EDIT_VIDEO = 1006;
    public static final int REQUEST_CODE_SHOOT_VIDEO = 1007;
    public static final int REQUEST_CODE_SELECT_PATH = 1009;
