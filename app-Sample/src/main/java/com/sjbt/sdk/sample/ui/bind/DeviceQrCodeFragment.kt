...
import com.sjbt.sdk.sample.databinding.FragmentDeviceQrCodeBinding
import com.sjbt.sdk.sample.ui.device.bind.DeviceBindFragment
import com.sjbt.sdk.sample.utils.viewbinding.viewBinding
import java.net.URLDecoder
import java.util.regex.Pattern

class DeviceQrCodeFragment : BaseFragment(R.layout.fragment_device_qr_code) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewBind.tvContent.text =
            "https://fitcloud.hetangsmart.com/qrcode/cn?MAC=AF:3C:21:B1:EF:61&BtName=Fit%20Watch"
