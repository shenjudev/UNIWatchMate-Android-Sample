...
public final class RegexUtils {
    ...
    public static boolean isMobileExact(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_MOBILE_NOT_EXACT, input);
    }
    ...
    public static boolean isInviteCode(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_INVITE_CODE, input);
    }
    ...
    public static boolean isLetter(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_LETTER, input);
    }
     ...
     * 限定汉字2-6字符
    * */
    public static boolean isUsernameQm(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_USERNAME_QM, input);
    }
    /**
     * 限定汉字2-6字符
     * */
    public static boolean isUsernameQmForeigh(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_USERNAME_QM_FOREIGN, input);
    }
    /**
