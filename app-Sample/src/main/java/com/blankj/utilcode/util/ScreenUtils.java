...
public final class ScreenUtils {
    ...
    public static float getAppScreenHeightWidthRate() {
        int appHeight = getAppScreenHeight();
        int appWidth = getAppScreenWidth();
        DecimalFormat dF = new DecimalFormat("0.00");
        String rate = dF.format((float) appHeight / appWidth);
