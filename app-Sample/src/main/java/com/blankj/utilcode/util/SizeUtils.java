...
public final class SizeUtils {
    ...
    public static float dp2pxFloat(final float dpValue) {
        final float scale = Utils.getApp().getResources().getDisplayMetrics().density;
    ...
    public static boolean smallFontType() {
    ...
    public static float getLetterLength(String text, TextView tv) {
        Paint paint = new Paint();
        paint.setTextSize(tv.getTextSize());
        paint.setLetterSpacing(tv.getLetterSpacing());
